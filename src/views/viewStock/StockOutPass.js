...
import '../../assets/css/viewStock/stockPass.css'
...
const StockOutPass = (props) => {
    return (
        <div className="stockOutPass">
            ...
            <footer>
                <div className="pass-payInfo">
                    <p>付款信息</p>
                </div>
                <div className="pass-payInfo-detail">
                    <div>
                        <p>
                            <span>付款类型：</span>
                            <span>现金</span>

        ...
        <div className="stockOutFail">
            <header>
                <div className='purchase-firtop'>
                    <div className='dynamic-top-left'>
                        ...
                        <p className='dynamic-top-word'>出库预览-待审批</p>
                    </div>
            ...
            <section>
                ...
                <div className="fail-info-detail">
                    <p>客户名称：<span>A客户</span></p>
                    <p>收款方式：<span>现金/支付宝/工行</span></p>
                    <p>业务员：<span>A员工</span></p>
                    <p>跟车配送员：<span>B员工</span></p>
                    <p>出货仓库：<span>A仓库</span></p>
